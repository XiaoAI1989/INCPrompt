...
def create_args():
    ...
    parser.add_argument('--learner_name', type=str, default='L2P', help="The class name of learner")
    ...
    parser.add_argument('--reg_item', type=int, default=0.1, help="the item of reg loss.")
    ...
    parser.add_argument('--prompt_param', nargs="+", type=float, default=[30, 20, 1],
                        help="prompt pool size, prompt length, prompt length")
