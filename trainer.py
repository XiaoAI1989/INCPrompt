...
class Trainer:
    ...
    def _build_learner_config(self):
        return {
            ...
            'routing_config': {
                ...
                'query_depth': self.args.routing_query_depth,
    ...
    def _save_routing_analysis(self, task_index):
        ...
        routing_tag = f'{self.args.routing_mode}_{self.args.routing_query_source}'
        if self.args.routing_query_source == 'shallow_pass':
            routing_tag = f'{routing_tag}{self.args.routing_query_depth}'
