...
class Trainer:
    ...
    def evaluate(self, avg_metrics):
        ...
        total_forgetting = 0
        for i in range(self.max_task):
            acc_org = metric_table['acc'][self.task_names[i]][self.task_names[i]]
            acc_final = metric_table['acc'][self.task_names[i]][self.task_names[self.max_task - 1]]
            forgetting = acc_org - acc_final
            total_forgetting += forgetting
        avg_f = total_forgetting / (self.max_task - 1)
